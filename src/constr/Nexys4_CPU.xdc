...
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0.000 5.000} [get_ports {clk100M}];
...
set_property -dict { PACKAGE_PIN R11   IOSTANDARD LVCMOS33 } [get_ports { cpu_prog_status_led}]; #IO_0_14 Sch=led17_g
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { gpu_prog_status_led }]; #IO_L11N_T1_SRCC_14 Sch=led17_r
...
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports {  cpu_prog_btn }]; #IO_L12P_T1_MRCC_14 Sch=btnl
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports {  gpu_prog_btn }]; #IO_L10N_T1_D15_14 Sch=btnr
